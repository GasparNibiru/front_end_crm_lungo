(() => {
  ...
  function renderSupervisorMocks() {
    ...
    document.querySelectorAll('#supervisorBrokerList .supervisor-broker-avatar img, #supervisorBrokerRows .supervisor-broker-avatar img').forEach(image=>{image.onerror=()=>image.remove();});
