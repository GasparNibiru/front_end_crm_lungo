(() => {
  ...
  function recruitmentActionIcon(kind) {
    const paths = {user:'<circle cx="12" cy="8" r="4"/><path d="M4 21v-2a8 8 0 0 1 16 0v2"/>', check:'<path d="m9 12 2 2 4-4"/><circle cx="12" cy="12" r="9"/>', fire:'<path d="M12 3c1 5 6 6 6 11a6 6 0 0 1-12 0c0-3 2-5 3-6 0 3 2 4 2 4s3-3 1-9Z"/><path d="M10 18c-1-2 1-3 2-5 0 2 3 3 2 5"/>'};
